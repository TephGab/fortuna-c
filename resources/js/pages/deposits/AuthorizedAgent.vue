...
<template>
    <Head title="Authorized Agent Deposit" />
    ...
    <div class="flex h-full flex-1 flex-col overflow-y-auto p-4 sm:p-6">
        ...
        <div class="mb-6 flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Authorized Agent Deposit</h1>
                <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">Deposit cash at any authorized Fortuna location</p>
            </div>
        </div>
        ...
        <div class="mb-6 flex items-center justify-center gap-2 rounded-full bg-emerald-50 px-4 py-2 dark:bg-emerald-900/20">
            ...
            <span class="text-sm font-medium text-emerald-700 dark:text-emerald-300">100% Secure & Verified Agents</span>
        </div>
        ...
        <div class="mb-6 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
            ...
            <div class="space-y-4">
                <div class="flex gap-3">
                    ...
                    <div>
                        <p class="font-medium text-gray-900 dark:text-white">Find an authorized center</p>
                        <p class="text-sm text-gray-500">Use our locator to find your nearest Fortuna Authorized Center</p>
                    </div>
                </div>
                <div class="flex gap-3">
                    ...
                    <div>
                        <p class="font-medium text-gray-900 dark:text-white">Visit with cash and ID</p>
                        <p class="text-sm text-gray-500">Bring your government-issued ID and the cash amount</p>
                    </div>
                </div>
                <div class="flex gap-3">
                    ...
                    <div>
                        <p class="font-medium text-gray-900 dark:text-white">Provide your registered email/phone</p>
                        <p class="text-sm text-gray-500">The authorized agent will verify and process your deposit</p>
                    </div>
                </div>
                <div class="flex gap-3">
                    ...
                    <div>
                        <p class="font-medium text-gray-900 dark:text-white">Funds credited instantly</p>
                        <p class="text-sm text-gray-500">Your wallet will be updated within minutes</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-6 rounded-2xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-gray-900/50">
            ...
            <div class="mt-2 flex items-center justify-between text-sm">
                <span class="text-gray-600 dark:text-gray-400">Minimum deposit</span>
                <span class="font-medium text-gray-900 dark:text-white">$20</span>
            </div>
            <div class="mt-2 flex items-center justify-between text-sm">
                <span class="text-gray-600 dark:text-gray-400">Maximum deposit</span>
                <span class="font-medium text-gray-900 dark:text-white">$5,000 per day</span>
            </div>
        </div>
        ...
        >
            ...
            {{ isLocating ? 'Locating nearest authorized center...' : 'Find nearest authorized center' }}
        </button>

        <!-- Nearest Authorized Agents List -->
        <div v-if="showNearestAgent" class="space-y-3 animate-fadeIn">
            <div class="flex items-center justify-between">
                <h3 class="text-sm font-medium text-gray-700 dark:text-gray-300">Authorized Centers Near You</h3>
                <span class="text-xs text-emerald-600 dark:text-emerald-400">✓ Verified by Fortuna</span>
            </div>
            <div 
        ...
        <div class="mt-6 rounded-xl border border-amber-200 bg-amber-50 p-4 dark:border-amber-800 dark:bg-amber-900/20">
            <div class="flex items-start gap-3">
                ...
                <div>
                    <p class="text-sm font-medium text-amber-800 dark:text-amber-300">Important Information</p>
                    <p class="text-xs text-amber-700 dark:text-amber-400 mt-1">
                        Always carry a valid government-issued ID. Deposits are processed within 15-30 minutes during business hours. 
                        Only use Fortuna Authorized Centers for secure transactions.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="mt-4 text-center">
            <a href="#" class="text-sm text-blue-600 hover:underline dark:text-blue-400">
                Need help finding an authorized center?
            </a>
        </div>
    </div>
</template>
