...
class MoneyRequestController extends Controller
{
    ...
    /**
     * Generate QR code with optional amount (PUBLIC method for route)
     */
    ...
    /**
     * Download QR code with optional amount (PUBLIC method for route)
     */
    public function downloadQRCode(Request $request)
    {
        ...
        $filename = $amount && $amount > 0 ? "payment-{$amount}.png" : "payment-qr.png";
